 ...
 */
const { getLatestNOAAFileLinks, fetchDataFromAPI } = require('../src/services/noaa.service');
const { calculateAndInsertEuclideanDistances } = require('../src/services/distances.service'); // <-- fixed path
